                ...
                <div className="pt-10">
                  <div className="text-white md:ml-10 lg:ml-10 md:pl-10 lg:pl-10 lg:w-1/2 absolute">
                    ...
                    <p className="mb-10 font-bold text-lg text-white flex justify-right pl-5 text-left">
                      ...
                      that are agile, scalable, and precisely sized to run your
                      organization optimally, simply, cost-effectively with
                      accurate financial and performance predictivity on a
                      subscription basis .
                    </p>
        ...
        <div className="bg-white pt-20 pb-20">
          ...
          <div className="grid grid-cols-7 bg-blue-500 text-white">
            <div className="col-span-5 col-start-2 text-center">
              ...
              DaaS reduces costs in areas such as procurement, imaging, physical
              ...
              receiving devices that are two years newer on average, which
              drives employee experience benefits while also reducing lifecycle
              associated costs. Both deployment and support ticket resolution
              times also improve.
              <div className="flex justify-center p-10 p-2">
                <Link
                  ...
                  className={[
                    "py-3 px-8 call_to_action1 text-white rounded-[30px] border-white",
                    styles.call_to_action1,
                  ].join(" ")}
                >
                  LEARN MORE
                </Link>
          ...
          <div className="mt-20 mb-20">
            ...
            <div className="lg:flex">
              {" "}
              <div
                className={["w-full lg:w-1/2 xs:w-full", styles.team].join(" ")}
              >
                <div>
                  <div className=" flex items-center justify-center">
                    <div
                      className={["lg:w-96 lg:h-96 md:h-64 md:w-64 sm:h-48 sm:w-48 xs:w-36 xs:h-36 rounded-lg my-5" , styles.photos] .join(" ")} 
          ...
          <div className="text-center m-10">
            <div className="grid grid-cols-8">
              <div className="col-span-6 col-start-2">
                ...
                click below to email our consultants. we will review your needs
